...
# # Create filename
# output_file = f"output_history_{now_str}.rtf"
# # Create file
# doc = Document(output_file)
#
# def create_user_paragraph(input: str):
#     paragraph = doc.add_paragraph()
#     run = paragraph.add_run(f"User: {input}")
#     run.font.color.rgb = RGBColor(0, 0, 0)  # Black text color
#     paragraph.style = 'Normal'  # Ensure default style (no shading)
#     paragraph.paragraph_format.shading.background_pattern_color.rgb = RGBColor(255, 255, 255)  # White background
#
# def create_bob_paragraph(input: str):
#     paragraph = doc.add_paragraph()
#     run = paragraph.add_run(f"Bob: {input}")
#     run.font.color.rgb = RGBColor(0, 0, 0)  # Black text color
#     paragraph.style = 'Normal'  # Ensure default style (no shading)
#     paragraph.paragraph_format.shading.background_pattern_color.rgb = RGBColor(0, 255, 0)  # Green background
#
# def create_mark_paragraph(input: str):
#     paragraph = doc.add_paragraph()
#     run = paragraph.add_run(f"Mark: {input}")
#     run.font.color.rgb = RGBColor(255, 255, 255)  # White text color
#     paragraph.style = 'Normal'  # Ensure default style (no shading)
#      paragraph.paragraph_format.shading.background_pattern_color.rgb = RGBColor(255, 0, 0)  # Red background
...
#         create_user_paragraph(text_task)
#         create_mark_paragraph(task_mark.output.result)
#         create_bob_paragraph(task_bob.output.result)
...
#         create_mark_paragraph(task_mark.output.result)
    ...
    emotion_scores = te.get_emotion(text_task)
    ...
    print(f"\n{Fore.WHITE}{Back.BLACK}{Style.BRIGHT}The dominant emotion in your input is "
          f"{Fore.WHITE}{Back.BLUE}{Style.BRIGHT}{max_emotion}{Fore.WHITE}{Back.BLACK}{Style.BRIGHT}"
          " with a score of "
          f"{Fore.WHITE}{Back.BLUE}{Style.BRIGHT}{max_score}{Fore.WHITE}{Back.BLACK}{Style.BRIGHT}."
          f"\n{Fore.WHITE}{Back.BLUE}{Style.BRIGHT}{emotion_scores}{Style.RESET_ALL}")
